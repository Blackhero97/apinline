        ...
        <div className="contact-box">
          <div className="contect-box-info card-padding">
            ...
            <div className="commitment card-padding">
              ...
              <ul>
                <li>
                  <i className="bx bxs-badge-check"></i>Swift responses,
                  dedicated support
                </li>
                <li>
                  <i className="bx bxs-badge-check"></i>Efficient and always
                  here for you
                </li>
                <li>
                  <i className="bx bxs-badge-check"></i>We listen, understand,
                  and act promptly
                </li>
              </ul>
            </div>
          ...
          <div className="contect-box-form card-padding">
            <form action="" onSubmit={sendMessageToTelegram}>
              ...
              {errorMessage && (
                <p className="text-center pt-2.5 text-red-500">
                  {errorMessage}
                </p>
              )}
